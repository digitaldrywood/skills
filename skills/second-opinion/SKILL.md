...
name: second-opinion
description: |
  Proactively suggest getting another LLM's perspective for complex architectural decisions,
  security-sensitive code, or design trade-offs. Activates when user faces multiple valid
  approaches, asks for "sanity check" or "what do you think". Does not activate for simple
  questions or when user has expressed a strong preference.
license: Apache-2.0
metadata:
  author: digitaldrywood
  version: "1.0.0"
---
