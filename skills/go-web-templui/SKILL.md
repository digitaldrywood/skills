...
name: go-web-templui
description: |
  templUI patterns and HTMX/Alpine.js best practices for Go/Templ web applications.
  Covers templ syntax, Script() templates, JavaScript interpolation, and component usage.
  Activates when building Go/Templ web apps or asking about templ syntax.
  Does not activate for non-Go projects.
license: Apache-2.0
metadata:
