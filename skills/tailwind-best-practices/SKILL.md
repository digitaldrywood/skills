...
description: |
  Tailwind CSS v4 patterns, utilities, and configuration best practices. Covers CSS-based
  theme configuration, @theme directive, dark mode, component extraction, and class ordering.
  Activates when working with Tailwind CSS. Does not activate for other CSS frameworks.
license: Apache-2.0
metadata:
