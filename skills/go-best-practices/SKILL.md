...
description: |
  Go idiomatic patterns and best practices for error handling, interfaces, concurrency,
  testing, and package organization. Activates when writing Go code, asking about Go
  patterns, or reviewing Go code. Does not activate for non-Go languages.
license: Apache-2.0
metadata:
